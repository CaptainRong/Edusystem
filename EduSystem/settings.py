...
SECRET_KEY = "django-insecure-*sv-4t=ov&!yb+rr+1!ff#(2mvn-i%w8_epv1=vn5wm=h8a_h2"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'edu_schema', #change the name of the database if using another custom database
        'HOST': '127.0.0.1',
        'PORT': '3306',
        'USER': 'root',
        'PASSWORD': '',
